...
(0, node_test_1.test)("review action pins GPT-5.6 Sol and caps thorough reviews at four agents", () => {
    ...
    // Both review and reply invocations must pin the model and reasoning effort.
    assert.equal(action.match(/codex exec --model gpt-5\.6-sol -c 'model_reasoning_effort="xhigh"'/g)?.length, 2);
